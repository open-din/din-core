...
pub use din_patch::{
    ...
    PATCH_INPUT_HANDLE_PREFIX, PATCH_SCHEMA_JSON, PatchConnection, PatchDocument, PatchError,
    ...
    PatchNodeData, PatchPosition, PatchToGraphOptions, ensure_unique_name,
    get_input_param_handle_id, get_source_handle_ids, get_target_handle_ids,
    get_transport_connections, graph_document_to_patch, is_audio_connection_like,
    migrate_patch_document, parse_graph_document, parse_patch_document, patch_to_graph_document,
    resolve_patch_asset_path, to_safe_identifier, validate_patch_document,
};
